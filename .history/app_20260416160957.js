document.addEventListener("DOMContentLoaded", () => {
                        ...
                        `<div class="card" onclick="window.location.href='detail.html?id=${prato.id}'" style="cursor: pointer">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <span class="price">${prato.preco.toLocaleString("pt-BR", {
                                        style: "currency",
                                        currency: "BRL"
                                    })}</span>
    ...
    async function listarPratos(){
        ...
        try{
            ...
            window.renderizarCategoria = function(itens, idCategoria){
                const container = document.getElementById(`categoria-${idCategoria}`);
                container.innerHTML = "";
                ...
                itens.forEach(prato => {
                    ...
                    <div class="card-body">
                        ...
                        <h3>${prato.nome}</h3>
                        <p>${prato.descricao}</p>
                        <span class="price">R$ ${prato.preco.toLocaleString("pt-BR", {
                            style: "currency",
                            currency: "BRL"
                        })}</span>
                    </div>
            ...
            window.ordenarCategoria = function(categoria, idCategoria, ordem){
                ...
                renderizarCategoria(itens, idCategoria);
            }

            Object.keys(categorias).forEach(categoria => {
                const itens = categorias[categoria];

                const idCategoria = categoria.replace(/\s+/g, "-");
                ...
                sessao.innerHTML +=
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; border-bottom:1px solid #333; padding-bottom:1rem; margin-bottom:2rem;">
                        ...
                        <select onchange="ordenarCategoria('${categoria}', '${idCategoria}', this.value)" 
                    ...
                    <div id="categoria-${idCategoria}" class="grid"></div>
                </div>`;
            ...
            sessao.innerHTML = "<p>Erro ao carregar cardápio!</p>";
        }
    }
    ...
    async function detalhesPratos(){
        ...
        try{
            ...
            `<div class="detail-container">
                ...
                <h1 style="margin-top: 1rem; font-size: 2.5rem;">${prato.nome}</h1>
                <p class="detail-price">R$ ${prato.preco.toLocaleString("pt-BR", {
                    style: "currency",
                    currency: "BRL"
                })}</p>
    ...
    async function sugestao(){
        ...
        try{
            const respostaProduto = await fetch(`https://api-restaurante-5iqb.onrender.com/api/produtos/${id}`)
            const produtoAtual = await respostaProduto.json();

            const resposta = await fetch(`https://api-restaurante-5iqb.onrender.com/api/produtos/categoria/${produtoAtual.categoria}`)
            ...
            sessao.innerHTML = "<p>Erro ao carregar sugestões!</p>";
        }
    }
