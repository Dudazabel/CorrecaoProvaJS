document.addEventListener("DOMContentLoaded", () => {
    ...
    async function buscarPratos(){
        ...
        try{
            ...
            listarPratos.sort((a, b) => a.preco - b.preco)
            
            listarPratos.forEach(prato =>{
            ...
            listarPratos.forEach(prato =>{
                ...
                sessao.innerHTML +=
                    `<div class="bloco-grupo-pratos" style="margin-bottom: 3rem;">
                        ...
                        <h2>${prato.categoria} <span style="font-size: 1rem; color: #888; font-weight: normal;"> - 2 itens</span></h2>
